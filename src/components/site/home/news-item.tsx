      ...
      <Card className='flex h-[22.375rem] gap-0 overflow-hidden rounded-[1rem] bg-white py-0 shadow-none ring-1 ring-[#e2e8ec] xsm:h-[18.5rem] xsm:rounded-[0.875rem]'>
        ...
        <div className='grid min-h-0 flex-1 grid-cols-[6.1875rem_minmax(0,1fr)] xsm:grid-cols-[4.75rem_minmax(0,1fr)]'>
          <div className='flex h-full flex-col items-center justify-center bg-brand-yellow px-[0.5rem] text-center text-white'>
            <span className='text-[2rem] font-bold leading-none xsm:text-[1.75rem]'>
              {item.publishedAt.day}
            </span>

            <span className='mt-[0.5rem] text-[0.75rem] leading-none xsm:mt-[0.375rem] xsm:text-[0.6875rem]'>
          ...
          <div className='min-w-0 overflow-hidden px-[1rem] pt-[0.5rem] pb-[0.625rem] xsm:px-[0.875rem] xsm:py-[0.75rem]'>
            <p className='text-[0.75rem] font-medium leading-[1.5] text-brand-blue xsm:text-[0.6875rem]'>
              {item.category}
            </p>

            <h3 className='mt-[0.375rem] line-clamp-2 text-[1rem] font-medium leading-[1.5] text-text-dark-blue xsm:mt-[0.25rem] xsm:text-[0.875rem] xsm:font-semibold xsm:leading-[1.45]'>
              <Link
                href={item.href}
                draggable={false}
            ...
            <p className='mt-[0.375rem] line-clamp-2 text-[0.75rem] leading-[1.5] text-text-dark-blue/65'>
              {item.excerpt}
            </p>
          </div>
        </div>
