        ...
        <div className='mt-[2rem] grid gap-[1rem] md:grid-cols-2 lg:grid-cols-3'>
          {doctors.map((doctor) => (
            ...
            >
              ...
              <h3 className='mt-[1rem] text-[1.125rem] font-semibold text-text-dark-blue'>
                {doctor.name}
              </h3>
              <p className='mt-[0.25rem] text-[0.9375rem] text-brand-blue'>{doctor.role}</p>
              <p className='mt-[0.5rem] text-[0.875rem] text-text-dark-blue/80'>
                {doctor.experience}
              </p>
              ...
              <ul className='mt-[0.75rem] space-y-[0.5rem]'>
                {doctor.specialties.map((specialty) => (
                  <li
                    key={specialty}
                    className='text-[0.875rem] text-text-dark-blue/80'
                  >
                    - {specialty}
                  </li>
                ))}
