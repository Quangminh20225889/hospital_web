              ...
              {doctors.map((doctor) => {
                ...
                return (
                  <article
                    key={doctor.id}
                    data-doctor-card
                    className='group relative h-[30.3125rem] basis-[calc((100%_-_2rem)/3)] shrink-0 overflow-hidden rounded-[1rem] border border-brand-blue/10 bg-[#eef7fd] xsm:h-[27rem] xsm:basis-full xsm:rounded-[0.875rem] 2xl:basis-[28.333333rem] 2xl:border-0 2xl:bg-white'
                  >
                    {}
                    {}
